...
namespace Tesco.Com.Framework.Services.Locator.Entities
{
...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName = "ILocatorSvcSDA", SessionMode = System.ServiceModel.SessionMode.NotAllowed)]
public interface ILocatorSvcSDA
{
    ...
    string GetAddressesByPostCodeHouseNumber(Tesco.Com.Framework.Services.Locator.Entities.IsAddressBlockedEntity[] isAddressBlocked);
...
public partial class LocatorSvcSDAClient : System.ServiceModel.ClientBase<ILocatorSvcSDA>, ILocatorSvcSDA
{
    ...
    public string GetAddressesByPostCodeHouseNumber(Tesco.Com.Framework.Services.Locator.Entities.IsAddressBlockedEntity[] isAddressBlocked)
    {
