<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerCards.aspx.cs"
    MasterPageFile="~/Site.Master" Inherits="CCODundeeApplication.CustomerCards"
    ...
    <div id="mainContent">
        <div class="ccBlueHeaderSection" id="divManageCardForm" runat="server">
            <div class="cc_bluehead">
                <h3>
                    <label for="Customer Cards"><asp:Localize ID="lclCustomerCards" runat="server" 
                        Text="Customer Cards" meta:resourcekey="lclCustomerCardsResource1"></asp:Localize></label></h3>
            </div>
            <div class="replacementCardNo" id="divReplaceCard" runat="server" style="display: none;">
                <label for="cardNumber">
                    <asp:Localize ID="lclcardNumber" runat="server" Text="CardNumber" 
                    meta:resourcekey="lclcardNumberResource1"></asp:Localize></label>
                <div class="inputFields">
                    <asp:TextBox ID="txtReplaceCardNo" runat="server" 
                        meta:resourcekey="txtReplaceCardNoResource1"></asp:TextBox>
                </div>
            </div>
            <div class="cc_body">
                ...
                <div class="reissueClubcardAcct" id="divMain" runat="server">
                    <div class="clubcardAct_head">
                        <h4>
                            <asp:Literal ID="ltrCardHeader" runat="server" 
                                meta:resourcekey="ltrCardHeaderResource1"></asp:Literal></h4>
                    </div>
                    <asp:Repeater ID="rptCardDetails" runat="server" 
                        OnItemDataBound="rptCardDetailsMain_ItemDataBound" 
                            ...
                            <table class="reissueCardHolderTbl">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <label for="Card status" style="width:100%"><asp:Localize ID="lclCardstatus" runat="server" 
                                                Text="Card status" meta:resourcekey="lclCardstatusResource1"></asp:Localize></label>
                                        </th>
                                        ...
                                        <th class="last" id="thReplace" runat="server">
                                            <label for="Replace" style="width:100%"><asp:Localize ID="lclReplace" runat="server" 
                                                Text="Replace" meta:resourcekey="lclReplaceResource1"></asp:Localize></label>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="ltrCardStatus" runat="server" 
                                        Text='<%# DataBinder.Eval(Container.DataItem, "ClubcardStatusDescEnglish") %>' 
                                        meta:resourcekey="ltrCardStatusResource2"></asp:LinkButton>
                                    <asp:Literal ID="lblCardStatus" runat="server" Visible="False" 
                                        Text='<%# DataBinder.Eval(Container.DataItem, "ClubcardStatusDescEnglish") %>'></asp:Literal>
                                </td>
                               ...
                               <td  id="tdrdbReplaceMain" runat="server">
                                     <asp:RadioButton ID="rdbReplaceMain" runat="server" Visible="False" 
                                        GroupName="rdbOption" meta:resourcekey="rdbReplaceMainResource2" />
                                    <asp:HiddenField ID="hdnCardNumber" runat="server" 
                                        Value='<%# DataBinder.Eval(Container.DataItem, "ClubCardID") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                        <AlternatingItemTemplate>
                            <tr class="alternate">
                                ...
                                <td id="tdrdbReplaceMain" runat="server">
                                    <asp:RadioButton ID="rdbReplaceMain" runat="server" Visible="False" 
                                        GroupName="rdbOption" meta:resourcekey="rdbReplaceMainResource1" />
                                    <asp:HiddenField ID="hdnCardNumber" runat="server" 
                                        Value='<%# DataBinder.Eval(Container.DataItem, "ClubCardID") %>' />
                                </td>
                            </tr>
                ...
                <div class="reissueCardReplace" runat="server" id="divReplaceSecMain" style="display: none;">
                    <div class="clubcardAct_head">
                        <h4>
                            <select>
                                <option><%=Resources.CSCGlobal.CardOption%></option>
                            </select>
                        </h4>
                    </div>
                    <div class="ccRightBorderSection" id="divReplaceSecMainSub" runat="server">
                            ...
                            <div class="ccPurpleGreySection">
                                <div class="cc_purpleGreyhead">
                                    <h4 style="height:20px">
                                        <label for="Replacement Request" style="width:100%;height:30px"><asp:Localize ID="lclReplacementRequest" 
                                            runat="server" Text="Replacement Request" 
                                ...
                                <div class="cc_greybody">
                                    <ul>
                                        <li>
                                            <label for="newCard">
                                                <strong><asp:Localize ID="lclnewCard" runat="server" Text="New card" 
                                                meta:resourcekey="lclnewCardResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioNewCardMain" runat="server" GroupName="OptionMain" 
                                                meta:resourcekey="RadioNewCardMainResource1" />
                                        </li>
                                        <li>
                                            <label for="newFob" style="height:30px;">
                                                <strong><asp:Localize ID="lclnewFob" runat="server" 
                                                Text="New key fob (set of 2)" meta:resourcekey="lclnewFobResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioNewFobMain" runat="server" GroupName="OptionMain" 
                                                meta:resourcekey="RadioNewFobMainResource1" />
                                        </li>
                                        <li>
                                            <label for="newCardAndFob" style="height:30px;">
                                                <strong><asp:Localize ID="lclnewCardAndFob" runat="server" 
                                                Text="New card and 2 key fobs" meta:resourcekey="lclnewCardAndFobResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioNewCardnFobMain" runat="server"
                                                GroupName="OptionMain" meta:resourcekey="RadioNewCardnFobMainResource1" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="orderRplcmnterrorFld">
                            <div class="ccPurpleGreySection">
                                <div class="cc_purpleGreyhead">
                                    <h4 style="height:20px">
                                        <label for="Reason" style="height:30px"><asp:Localize ID="lclReasion" runat="server" Text="Reason" 
                                            meta:resourcekey="lclReasionResource1"></asp:Localize></label></h4>
                                </div>
                                <div class="cc_greybody">
                                    <ul>
                                        <li>
                                            <label for="lost"style="height:30px;">
                                                <strong><asp:Localize ID="lcllost" runat="server" 
                                                Text="Lost my card / key fob" meta:resourcekey="lcllostResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioLostMain" runat="server" GroupName="ReasonMain" 
                                                meta:resourcekey="RadioLostMainResource1" />
                                        </li>
                                        <li>
                                            <label for="damaged">
                                                <strong><asp:Localize ID="lclstolen" runat="server" Text="Damaged" 
                                                meta:resourcekey="lclstolenResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioDamagedMain" runat="server" GroupName="ReasonMain" 
                                                meta:resourcekey="RadioDamagedMainResource1" />
                                        </li>
                                        <li>
                                            <label for="stolen">
                                                <strong><asp:Localize ID="Localize3" runat="server" Text="Stolen" 
                                                meta:resourcekey="Localize3Resource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioStolenMain" runat="server" GroupName="ReasonMain" 
                                                meta:resourcekey="RadioStolenMainResource1" />
                                        </li>
                                        <li style="height:30px">
                                            ...
                                            <asp:RadioButton ID="RadioMoreFobsMain" runat="server" GroupName="ReasonMain" 
                                                meta:resourcekey="RadioMoreFobsMainResource1" />
                                        </li>
                                        <br />
                                        <li>
                                            <label for="others">
                                                <strong><asp:Localize ID="lclothers" runat="server" Text="Other" 
                                                meta:resourcekey="lclothersResource1"></asp:Localize></strong></label>
                                            <asp:RadioButton ID="RadioOtherMain" runat="server" GroupName="ReasonMain" 
                                                meta:resourcekey="RadioOtherMainResource1" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="reissueClubcardMain">
                    <div class="reissueClubcardAcct" id="divAssociate" runat="server" visible="false">
                        <div class="clubcardAct_head">
                            <h4>
                                <asp:Literal ID="ltrCardHeaderAssociate" runat="server" 
                                    meta:resourcekey="ltrCardHeaderAssociateResource1"></asp:Literal></h4>
                        </div>
                        <asp:Repeater ID="rptCardDetailsAssociate" runat="server" 
                            OnItemDataBound="rptCardDetailsAssociate_ItemDataBound" 
                                ...
                                <table class="reissueCardHolderTbl">
                                    <thead>
                                        <tr>
                                            <th>
                                                <label for="Card number" style="width:100%"><asp:Localize ID="lclCardnumber" runat="server" 
                                                    Text="Card number" meta:resourcekey="lclCardnumberResource3"></asp:Localize></label>
                                            </th>
                                            <th>
                                                <label for="Issue date" style="width:100%"><asp:Localize ID="lclIssuedate" runat="server" 
                                                    Text="Issue date" meta:resourcekey="lclIssuedateResource2"></asp:Localize></label>
                                            </th>
                                            <th>
                                                <label for="Card status" style="width:100%"><asp:Localize ID="lclCardstatus" runat="server" 
                                                    Text="Card status" meta:resourcekey="lclCardstatusResource2"></asp:Localize></label>
                                            </th>
                                            <th ID="thTypeofcard" runat="server">
                                                <label for="Type of card" style="width:100%"><asp:Localize ID="lclTypeofcard" runat="server" 
                                                    Text="Type of card" meta:resourcekey="lclTypeofcardResource2"></asp:Localize></label>
                                            </th>
                                            <th class="last" id="thReplace" runat="server">
                                                <label for="Replace" style="width:100%"><asp:Localize ID="lclReplace" runat="server" 
                                                    Text="Replace" meta:resourcekey="lclReplaceResource2"></asp:Localize></label>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="ltrCardStatusAssoc" runat="server" 
                                            Text='<%# DataBinder.Eval(Container.DataItem, "ClubcardStatusDescEnglish") %>' 
                                            meta:resourcekey="ltrCardStatusAssocResource1"></asp:LinkButton>
                                             
                                    <asp:Literal ID="lblCardStatusAssoc" runat="server" Visible="False" 
                                        Text='<%# DataBinder.Eval(Container.DataItem, "ClubcardStatusDescEnglish") %>'></asp:Literal>
                                    </td>
                                      <td id="tdTypeofCard" runat="server">
                                        <asp:Literal ID="ltrTypeofCard" runat="server" 
                                      ...
                                      <td  id="tdrdbReplaceMain" runat="server">
                                        <asp:RadioButton ID="rdbReplaceAssociate" runat="server" Visible="False" 
                                            GroupName="rdbOption" meta:resourcekey="rdbReplaceAssociateResource2" />
                                        <asp:HiddenField ID="hdnCardNumber" runat="server" 
                                            Value='<%# DataBinder.Eval(Container.DataItem, "ClubCardID") %>' />
                                    </td>
                                </tr>
                                ...
                                <tr class="alternate">
                                    ...
                                    <asp:Literal ID="lblCardStatusAssoc" runat="server" Visible="False" 
                                     ...
                                     <td id="tdTypeofCard" runat="server">
                                      ...
                                      <td id="tdrdbReplaceMain" runat="server">
                                        <asp:RadioButton ID="rdbReplaceAssociate" runat="server" Visible="False" 
                                            GroupName="rdbOption" meta:resourcekey="rdbReplaceAssociateResource1" />
                                        <asp:HiddenField ID="hdnCardNumber" runat="server" 
                                            Value='<%# DataBinder.Eval(Container.DataItem, "ClubCardID") %>' />
                                    </td>
                                </tr>
                        ...
                        <div class="ccRightBorderSection" id="divReplaceSecAssociateSub" runat="server">
                            <div class="orderRplcmnterrorFld" style="display: none">
                                <div class="ccPurpleGreySection">
                                    <div class="cc_purpleGreyhead">
                                        <h4 style="height:20px">
                                            <label for="Replacement Request" style="height:30px;width:100%"><asp:Localize ID="lclReplacement" 
                                                runat="server" Text="Replacement Request"
                                                meta:resourcekey="lclReplacementResource1"></asp:Localize></label></h4>
                                    </div>
                                    <div class="cc_greybody">
                                        <ul>
                                            <li>
                                                <label for="newCard">
                                                    <strong><asp:Localize ID="lclnewCard1" runat="server" Text="New card" 
                                                    meta:resourcekey="lclnewCard1Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioNewCard" runat="server" GroupName="Option" 
                                                    meta:resourcekey="RadioNewCardResource1" />
                                            </li>
                                            <li>
                                                <label for="newFob" style="height:30px">
                                                    <strong><asp:Localize ID="lclnewFob1" runat="server" 
                                                    Text="New key fob (set of 2)" meta:resourcekey="lclnewFob1Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioNewFob" runat="server" GroupName="Option" 
                                                    meta:resourcekey="RadioNewFobResource1" />
                                            </li>
                                            <li>
                                                <label for="newCardAndFob" style="height:30px">
                                                    <strong><asp:Localize ID="lclnewCardAndFob1" runat="server" 
                                                    Text="New card and 2 key fobs" meta:resourcekey="lclnewCardAndFob1Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioNewCardnFob" runat="server" GroupName="Option" 
                                                    meta:resourcekey="RadioNewCardnFobResource1" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="orderRplcmnterrorFld">
                                <div class="ccPurpleGreySection">
                                    <div class="cc_purpleGreyhead">
                                        <h4 style="height:20px">
                                            <label for="Reason" style="height:30px"><asp:Localize ID="lclReasion1" runat="server" Text="Reason" 
                                                meta:resourcekey="lclReasion1Resource1"></asp:Localize></label></h4>
                                    </div>
                                    <div class="cc_greybody">
                                        <ul>
                                            <li>
                                                <label for="lost" style="height:30px">
                                                    <strong><asp:Localize ID="lcllost2" runat="server" 
                                                    Text="Lost my card / key fob" meta:resourcekey="lcllost2Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioLost" runat="server" GroupName="Reason" 
                                                    meta:resourcekey="RadioLostResource1" />
                                            </li>
                                            <li>
                                                <label for="damaged">
                                                    <strong><asp:Localize ID="Localize2" runat="server" Text="Damaged" 
                                                    meta:resourcekey="Localize2Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioDamaged" runat="server" GroupName="Reason" 
                                                    meta:resourcekey="RadioDamagedResource1" />
                                            </li>
                                            <li>
                                                <label for="stolen">
                                                    <strong><asp:Localize ID="lclstolen2" runat="server" Text="Stolen" 
                                                    meta:resourcekey="lclstolen2Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioStolen" runat="server" GroupName="Reason" 
                                                    meta:resourcekey="RadioStolenResource1" />
                                            </li>
                                            <li>
                                                <label for="moreFobs" style="height:30px">
                                                    <strong><asp:Localize ID="lclmoreFobs2" runat="server" 
                                                    Text="Need more fobs for your household" 
                                                    meta:resourcekey="lclmoreFobs2Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioMoreFobs" runat="server" GroupName="Reason" 
                                                    meta:resourcekey="RadioMoreFobsResource1" />
                                            </li>
                                            <li>
                                                <label for="others">
                                                    <strong><asp:Localize ID="lclothers2" runat="server" Text="Other" 
                                                    meta:resourcekey="lclothers2Resource1"></asp:Localize></strong></label>
                                                <asp:RadioButton ID="RadioOther" runat="server" GroupName="Reason" 
                                                    meta:resourcekey="RadioOtherResource1" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="noteText errorFields" id="divNonStandardCardMsg" runat="server" style="display: none;">
                        <label for="servicereissuing" style="width:100%"><asp:Localize ID="lclservicereissuing" 
                            runat="server" Text="This service is for reissuing standard clubcards only." 
...
<br/>
                    ...
                    <h3>
                        <label for="CusStatus"><asp:Localize ID="lclCusStatus" runat="server" 
                            Text="Add Card" meta:resourcekey="lclstatusofcustomerResource1"></asp:Localize></label></h3>
                </div></br>
                    <div id="dvMainAssCus" runat="server" visible="false">
                    <table width="75%">
                    <tr>
                    <td class="style3">
                    <asp:RadioButton ID="RBMain" runat="server" GroupName="ReplacePrimary1" 
                            Checked="True" AutoPostBack="true" 
                            oncheckedchanged="RBMain_CheckedChanged"/><b><asp:Label ID="Label1" Text="Main Customer" runat="server"></asp:Label></b>
                                        
                                       
                              
                    </td>
                    <td>
                    <asp:RadioButton ID="RBAssociative" runat="server"  GroupName="ReplacePrimary1" 
                            AutoPostBack="true" oncheckedchanged="RBAssociative_CheckedChanged"/><b><asp:Label ID="Label2" Text="Associative Customer" runat="server"></asp:Label></b>
                    ...
                    <p class="pageAction" id="pbtnConfirm" runat="server">
                        <table id="AddCardToAccount" runat="server" visible="false">
                            <tr>
                                <td class="style1">
                                    <label for="Card No" style="width:100%" ><asp:Localize ID="lclCardNo1" runat="server" 
                                        Text="Card No." meta:resourcekey="lclCardNo1Resource1"></asp:Localize></label>
                                </td>
                                <td class="style1">
                                    <asp:TextBox ID="txtCardNumber" MaxLength="18" runat="server" 
                                ...
                                <td class="style1">
                                    <label for="Replace Primary" style="width:100%"><asp:Localize ID="lclReplaceSummary" 
                                        runat="server" Text="Replace Primary" 
                                        meta:resourcekey="lclReplaceSummaryResource1"></asp:Localize></label>
                                </td>
                                <td class="style2">
                                    ...
                                    <asp:RadioButton ID="rdbReplacePrimaryNo" runat="server" Checked="True" GroupName="ReplacePrimary" Width="100px"
                                        Text="No" meta:resourcekey="rdbReplacePrimaryNoResource1"/>
                        ...
                        <div style="float: left;">
                            <asp:ImageButton ID="imgbtnChangePrimary" runat="server" CssClass="imgBtn" ImageUrl="~/I/ChangePrimary.gif"
                                OnClick="imgbtnChangePrimary_Click" 
                                meta:resourcekey="imgbtnChangePrimaryResource1"/>
                        </div>
                        <asp:ImageButton ID="orderConfirm" CssClass="imgBtn" 
                        ImageUrl="~/I/Confirmbtn.JPG" runat="server"
                            OnClientClick="return errorMessageCheck();" 
                        OnClick="orderConfirm_Click" meta:resourcekey="orderConfirmResource1" />
                    </p>
                    </div>
                    ...
                    <p class="noteText errorFields" id="pInProcessMsg" runat="server" style="display: none;">
                        <label for="reissue" style="width:100%"><asp:Localize ID="reissued" runat="server" 
                            Text="There is already a re-issue order processing for this account." 
                            meta:resourcekey="reissuedResource1"></asp:Localize></label><br />
                        <br />
                        <label for="normalDelivary" style="width:100%"><asp:Localize ID="lclNrmlDelivary" runat="server" 
                            Text="Inform the Customer that the delivery is normally within 3 weeks of their order." 
                    ...
                    <p class="noteText errorFields" id="pInConfirmMsg" runat="server" style="display: none;">
                        <label for="processReq" style="width:100%"><asp:Localize ID="processReq" runat="server" 
                            Text="Replacement request has been processed successfully." 
                            meta:resourcekey="processReqResource1"></asp:Localize></label><br />
                        <br />
                        <label for="normalDelivary" style="width:100%"><asp:Localize ID="lclNrmlDelivary1" runat="server" 
                            Text="Inform the Customer that the delivery is normally within 3 weeks of their order." 
                    ...
                    <p class="noteText errorFields" id="pMaxOrdersReached" runat="server" style="display: none;">
                        <label for="cardReissue" style="width:100%"><asp:Localize ID="lclcardReissue" runat="server" 
                            Text="Inform Customer that they are no longer able to request Card Re-Issues through their" 
                            meta:resourcekey="lclcardReissueResource1"></asp:Localize></label>
                        <label for="cconlineAcc" style="width:100%"><asp:Localize ID="lclcconlineAcc" runat="server" 
                            Text="Clubcard Online account as they have reached the online re-issue threshold." 
                    ...
                    <p class="noteText errorFields" id="pInvalidReason" runat="server" style="display: none;">
                        <label for="cardReissue" style="width:100%"><asp:Localize ID="lclInvalidresoncode" runat="server" 
                            Text="Please select Reason code" 
        ...
        <div>
            <table class="vouchDtlTbl">
                <thead>
                    <tr>
                        <th class="rounded-company first">
                            <label for="EditCardDetails"><asp:Localize ID="lclEditCardDetails" 
                                runat="server" Text="Edit Card Details" 
                                meta:resourcekey="lclEditCardDetailsResource1"></asp:Localize></label>
                        </th>
                ...
                <tbody>
                    <tr class="alternate">
                        <td>
                            <label for="Status"><asp:Localize ID="lclStatus1" runat="server" Text="Status" 
                                meta:resourcekey="lclStatus1Resource1"></asp:Localize></label>
                        </td>
                        <td class="last">
                    ...
                    <tr>
                        <td class="lastRw" colspan="2">
                            <asp:ImageButton ID="imgConfirm" ImageUrl="~/I/confirm.gif" runat="server" 
