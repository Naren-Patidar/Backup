...
{
    /// <summary>
    /// Description: To display Customer Cards and allow to replace Standard cards
    /// Author: Robin Apoto
    /// Date: 03/July/2010
    /// Modified: Kumar P
    /// Description: MKTG00007296 01-08-2012  Kumar P
    /// Modified: Kumar P
    /// Description: MKTG00007324 07-08-2012  Kumar P
    /// </summary>


    public partial class CustomerCards : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("CustomerCardsRecarding.aspx");
            }
        }
        ...
        //    CustomerServiceClient CusObj = new CustomerServiceClient();
        //    try
        //    {
        //        if (txtCardNumber.Text.Trim() != null)
        //        {
        //            inputParams["ClubcardID"] = txtCardNumber.Text.Trim();
        //            conditionXml = Helper.HashTableToXML(inputParams, "customer");
        //            if (CusObj.GetCustomerDetails(out errorXml, out resultXml, out rowCount, conditionXml, maxRowCount, Culture))
        //            {
        ...
        //                    if (RBMain.Checked == true)
        //                    {
        //                        if (!((dsCustomer.Tables["customer"].Rows[0]["Name1"] == CusName1) && (dsCustomer.Tables["customer"].Rows[0]["Name2"] == CusName2) && (dsCustomer.Tables["customer"].Rows[0][" Name2"] == CusName3)))
        //                        {
        //                            lblSuccessMessage.Text = "Card is already Existed to some other customer";
        //                        }

        //                    }
        //                    else
        //                    {
        //                        if (!((dsCustomer.Tables["customer"].Rows[0]["Name1"] == ACusName3) && (dsCustomer.Tables["customer"].Rows[0]["Name2"] == ACusName2) && (dsCustomer.Tables["customer"].Rows[0][" Name2"] == ACusName3)))
        //                        {
        //                            lblSuccessMessage.Text = "Card is already Existed to some other customer";
        //                        }
