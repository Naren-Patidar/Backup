<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClubcardRegistrationReport.aspx.cs"
    MasterPageFile="~/Site.Master" Inherits="CCODundeeApplication.Reports.ClubcardRegistrationReport"
    Title="Clubcard Registration Report" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
    ...
    <div id="mainContent">
        <div class="ccBlueHeaderSection">
            <div class="cc_bluehead">
                <h3>
                    <asp:Localize ID="lclHeader" runat="server" Text="Customer Load Report" meta:resourcekey="lclHeaderResource1"></asp:Localize>
                </h3>
            </div>
            <div class="cc_body">
                <div class="UserDetails">
                    <span runat="server" id="spanMessageTop"><b>
                        <asp:Localize ID="lclSelectInput" runat="server" Text="Select input" meta:resourcekey="lclSelectInputResource1"></asp:Localize></b></span>
                </div>
                <b><span runat="server" id="spanMessageBelow">
                    <br />
                    <asp:Localize ID="lclTimeFrame" runat="server" Text="Time frame" meta:resourcekey="lclTimeFrameResource1"></asp:Localize>
                ...
                <table width="100%">
                    <tr>
                        <td width="1%">
                            <asp:RadioButton ID="rdoDate" Checked="True" runat="server" AutoPostBack="True" OnCheckedChanged="TimeFrame_SelectedIndexChanged"
                                GroupName="TimeFrame" meta:resourcekey="rdoDateResource1" />
                        </td>
                        <td width="14%">
                            <span runat="server" id="spanStartDateMessage">
                                <asp:Localize ID="lclStartDate" runat="server" Text="Start date" meta:resourcekey="lclStartDateResource1"></asp:Localize></span>
                        </td>
                        <td width="35%">
                            <span id="spanStartDate0" class="<%=spanClassDOBDropDown0%>">
                                <asp:DropDownList runat="server" ID="ddlStartDay" class="day" meta:resourcekey="ddlStartDayResource1">
                                    <asp:ListItem Value="0" meta:resourcekey="ListItemResource1">Day</asp:ListItem>
                                ...
                                <asp:DropDownList runat="server" ID="ddlStartMonth" class="month" meta:resourcekey="ddlStartMonthResource1" />
                                <asp:DropDownList runat="server" ID="ddlStartYear" class="year" meta:resourcekey="ddlStartYearResource1" />
                            </span>
                        </td>
                        <td width="1%">
                        </td>
                        ...
                        <td width="35%">
                            <span id="spanEnddate0" class="<%=spanClassDOBDropDown0%>">
                                <asp:DropDownList runat="server" ID="ddlEndDay" class="day" meta:resourcekey="ddlEndDayResource1">
                                    <asp:ListItem Value="0" meta:resourcekey="ListItemResource33">Day</asp:ListItem>
                                ...
                                <asp:DropDownList runat="server" ID="ddlEndMonth" class="month" meta:resourcekey="ddlEndMonthResource1" />
                                <asp:DropDownList runat="server" ID="ddlEndYear" class="year" meta:resourcekey="ddlEndYearResource1" />
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" style="width: 45%">
                            <div id="divEndDate" runat="server">
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:RadioButton ID="rdoWeekNo" runat="server" AutoPostBack="True" OnCheckedChanged="TimeFrame_SelectedIndexChanged"
                                GroupName="TimeFrame" meta:resourcekey="rdoWeekNoResource1" />
                        </td>
                        <td>
                            <span runat="server" id="spnWeekNo">
                                <asp:Localize ID="lclWeekNumber" runat="server" Text="Week number" meta:resourcekey="lclWeekNumberResource1"></asp:Localize></span>
                        </td>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlWeek" class="month" meta:resourcekey="ddlWeekResource1" />
                        </td>
                        <td>
                            <asp:RadioButton ID="rdoPeriod" runat="server" AutoPostBack="True" OnCheckedChanged="TimeFrame_SelectedIndexChanged"
                                GroupName="TimeFrame" meta:resourcekey="rdoPeriodResource1" />
                        </td>
                        <td>
                            <span runat="server" id="spnPeriod">
                                <asp:Localize ID="lclPeriod" runat="server" Text="Period" meta:resourcekey="lclPeriodResource1"></asp:Localize></span>
                        </td>
                        <td>
                            <asp:DropDownList runat="server" ID="ddlPeriod" class="month" meta:resourcekey="ddlPeriodResource1" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Button ID="btnScheduleRpt" Text="Schedule report >" runat="server" OnClick="btnScheduleRpt_Click"
                                meta:resourcekey="btnScheduleRptResource1" OnClientClick="return ValidateDateRegReport()"/>
                        </td>
                        <td>
                            <asp:Button ID="btnRunRpt" Text="Run report >" runat="server" OnClick="btnRunRpt_Click"
                                meta:resourcekey="btnRunRptResource1" OnClientClick="return ValidateDateRegReport()" />
                        </td>
                    </tr>
                </table>
            </div>
