<%@ Page Language="C#" AutoEventWireup="true" Title="Points Earned Report" CodeBehind="PointsEarnedReport.aspx.cs" MasterPageFile="~/Site.Master" Inherits="CCODundeeApplication.Reports.PointsEarnedReport" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <div id="mainContent">
        <div class="ccBlueHeaderSection">
            <div class="cc_bluehead">
                 <h3><asp:Localize ID="lclHeader" runat="server" Text="Points Earned During A period" 
            ...
            <div class="UserDetails">
                     ...
                     <asp:Localize ID="lclselectinput"  runat="server" Text="Select input" 
                                meta:resourcekey="Selectinput"></asp:Localize>
          ...
          <b>
               ...
               <br /><asp:Localize ID="lcltimeframe" runat="server" Text="Time frame" meta:resourcekey="Timeframe"></asp:Localize>
                ...
                <br />
                         ...
                         <tr>
                                <td colspan="6" align="center">
                                        ...
                                        <div id="div1" runat="server">
                                         <asp:Label ID="lblermsg" ForeColor="Red" runat="server" 
                        ...
                        <tr>
                                <td width="1%">
                                <asp:RadioButton id="rdoDate" checked="True" runat="server" GroupName="TimeFrame" 
                                        AutoPostBack="True"  oncheckedchanged="TimeFrame_SelectedIndexChanged"  meta:resourcekey="rdoDateResource1"/>
                                </td>
                                <td width="14%">
                                <span runat="server" id="spanStartDateMessage">
                                <asp:Localize ID="lclHeader1" runat="server" meta:resourcekey="lclStartDate"></asp:Localize></span>
                                </td>
                                <td width="35%">
                                <span id="spanStartDate 0" class="<%=spanClassDOBDropDown0%>">
                                ...
                                <td width="14%">
                                 ...
                                 <asp:Localize ID="lclenddate" runat="server" Text="End date" meta:resourcekey="Enddate"></asp:Localize>
                                 </span>
                                </td>
                                <td width="35%">
                        ...
                        <tr>
                          ...
                          <tr>
                                 <td>
                                  ...
                                  GroupName="TimeFrame" oncheckedchanged="TimeFrame_SelectedIndexChanged" 
                                         meta:resourcekey="rdoWeekNoResource1" />
                                </td>
                                <td>
                                 <span runat="server" id="spnWeekNo">
                                 <asp:Localize ID="lclweekno" runat="server" Text="Week number" meta:resourcekey="Weeknumber"></asp:Localize>    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                 <asp:RadioButton  id="rdoPeriod" runat="server" AutoPostBack="True" GroupName="TimeFrame" 
                                        oncheckedchanged="TimeFrame_SelectedIndexChanged" 
                                        meta:resourcekey="rdoPeriodResource1"/>
                                </td>
                                <td>
                                <span runat="server" id="spnPeriod">
                                <asp:Localize ID="lclperiod" runat="server" Text="Period" meta:resourcekey="Period"></asp:Localize>
                                </span>
                                </td>
                                <td>
               ...
               <td><asp:Button ID="btnScheduleRpt" text="Schedule report >" runat="server" 
                       meta:resourcekey="btnScheduleRptResource1" OnClientClick="return ValidateDateRegReport()" onclick="btnScheduleRpt_Click"/></td>
     ...
     function ValidateDateRegReport() {
         ...
         if (document.getElementById('<%= rdoWeekNo.ClientID %>').checked == true) {
             if (ddlWeek.value == "-1") {
                 ...
                 document.getElementById('<%= divWeek.ClientID %>').innerText = '<%=Resources.CSCGlobal.InvalidWeek %>';
         ...
         if (document.getElementById('<%= rdoPeriod.ClientID %>').checked == true) {
             if (ddlPeriod.value == "-1") {
                 ...
                 document.getElementById('<%= divPeriod.ClientID %>').innerText = '<%=Resources.CSCGlobal.InvalidPeriod %>';
         ...
         if (document.getElementById('<%= rdoDate.ClientID %>').checked == true) {
             ...
             if (ddlStartDay.value == "0" && ddlStartMonth.value == "- Select Month -" && ddlStartYear.value == "Year" && ddlEndDay.value == "0" && ddlEndMonth.value == "- Select Month -" && ddlEndYear.value == "Year") {
                 document.getElementById('<%= divStartDate.ClientID %>').innerText = '<%=Resources.CSCGlobal.InvalidStartdate %>';
                 document.getElementById('<%= divEndDate.ClientID %>').innerText = '<%=Resources.CSCGlobal.InvalidEnddate %>';
                 ...
                 if (errorFlagStartDate == "" && errorFlagEndDate == "") {
                     ...
                     if (dayDiff > 80) {
                         document.getElementById('<%= divEndDate.ClientID %>').innerText = "Date Difference Shouldn't Be More Than 80 Days";
                         document.getElementById('<%= divEndDate.ClientID %>').style.color = "red";
                     ...
                     if (FromDate > ToDate) {
                         ...
                         document.getElementById('<%= divEndDate.ClientID %>').innerText = '<%=Resources.CSCGlobal.EnddateshouldbegreaterthanStartdate %>'; 
                         document.getElementById('<%= divEndDate.ClientID %>').style.color = "red";
                         document.getElementById('<%= divStartDate.ClientID %>').style.bold = true;
                         return false;
                     }
                     ...
                     if (ToDate > varCurrentDate) {
                         document.getElementById('<%= divEndDate.ClientID %>').innerText = '<%=Resources.CSCGlobal.EnddategreaterthanTodaydate %>'; 
                         document.getElementById('<%= divEndDate.ClientID %>').style.color = "red";
                         document.getElementById('<%= divStartDate.ClientID %>').style.bold = true;
                         return false;
                     }
                     ...
                     if (FromDate > varCurrentDate) {
                         document.getElementById('<%= divStartDate.ClientID %>').innerText = '<%=Resources.CSCGlobal.StartdateshouldnotbegreaterthanTodaydate %>'; 
                         document.getElementById('<%= divStartDate.ClientID %>').style.color = "red";
                         document.getElementById('<%= divStartDate.ClientID %>').style.bold = true;
                         return false;
                     }
