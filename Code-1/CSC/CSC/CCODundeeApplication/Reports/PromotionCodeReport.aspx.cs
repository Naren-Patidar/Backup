#region Codes To Generate Promotion Code Report
//Author -Mohan Mahapatra
//Purpose of report : This report is generated to find out total customers joined through various Promotion Codes in specified time frame
...
{
    #region class
    public partial class PromotionCodeReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    #region Trace Start
                    NGCTrace.NGCTrace.TraceInfo("Start: CSC - Promotion Code Report - Page_Load");
                    NGCTrace.NGCTrace.TraceDebug("Start: CSC - Promotion Code Report - Page_Load");
                    #endregion
                ...
                #region Trace End
                NGCTrace.NGCTrace.TraceInfo("End: CSC - Promotion Code Report - Page_Load");
                NGCTrace.NGCTrace.TraceDebug("End: CSC - Promotion Code Report - Page_Load");
                #endregion
            }
            catch (Exception ex)
            {
                #region Trace Error
                NGCTrace.NGCTrace.TraceCritical("Critical: CSC - Promotion Code Report - Page_Load- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceError("Error: CSC - Promotion Code Report - Page_Load- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceWarning("Warning: CSC - Promotion Code Report - Page_Load :" + ex.ToString());
        ...
        private bool ScheduleReport()
        {
            ...
            {
                #region Trace Start
                NGCTrace.NGCTrace.TraceInfo("Start: CSC - Promotion Code Report - ScheduleReport()");
                NGCTrace.NGCTrace.TraceDebug("Start: CSC - Promotion Code Report - ScheduleReport()");
                #endregion
                ...
                //ds = objReportingService.GetPromotionalReport(stDate, edDate, week, period.ToString());
                ...
                //{
                    ...
                    string reportName = "PromotionalCodeReport";
                    ...
                    #region Trace End
                    NGCTrace.NGCTrace.TraceInfo("End: CSC - Promotion Code Report - ScheduleReport()");
                    NGCTrace.NGCTrace.TraceDebug("End: CSC - Promotion Code Report - ScheduleReport()");
                    return true;
                    #endregion
                //}
            ...
            {
                #region Trace Error
                NGCTrace.NGCTrace.TraceCritical("Critical: CSC - Promotion Code Report - ScheduleReport()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceError("Error: CSC - Promotion Code Report - ScheduleReport()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceWarning("Warning: CSC - Promotion Code Report - ScheduleReport() :" + ex.ToString());
                NGCTrace.NGCTrace.ExeptionHandling(ex);
                #endregion Trace Error
                return false;
        ...
        private bool GenerateReport()
        {
            ...
            {
                #region Trace Start
                NGCTrace.NGCTrace.TraceInfo("Start: CSC - Promotion Code Report - GenerateReport()");
                NGCTrace.NGCTrace.TraceDebug("Start: CSC - Promotion Code Report - GenerateReport()");
                #endregion
                string timeFrame = GetLocalResourceObject("lclTimeFrameResource1.Text").ToString();
                int week = 0;
                string period = "";
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string reportName = GetLocalResourceObject("CSC.PromotionalCodeReport.Report.Name").ToString();
                    string reportRunDate = GetLocalResourceObject("CSC.PromotionalCodeReport.ColumnName.ReportRunDate").ToString();
                    ...
                    for (int m = 0; m < ds.Tables[0].Columns.Count; m++)
                    {
                        ...
                        if (m == 0)
                            localizedHeader = GetLocalResourceObject("CSC.PromotionalCodeReport.ColumnName." + colHeader).ToString();
                        else
                    ...
                    string sFile = ExtracttoExcel.ExportExcel(ds.GetXml(), reportName, reportRunDate, htLocalisedColNames, headerXml, "PromotionalCodeReport");
                    ...
                    #region Trace End
                    NGCTrace.NGCTrace.TraceInfo("End: CSC - Promotion Code Report - GenerateReport()");
                    NGCTrace.NGCTrace.TraceDebug("End: CSC - Promotion Code Report - GenerateReport()");
                    #endregion
                    return true;
                }
                else
            ...
            {
                #region Trace Error
                NGCTrace.NGCTrace.TraceCritical("Critical: CSC - Promotion Code Report - GenerateReport()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceError("Error: CSC - Promotion Code Report - GenerateReport()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceWarning("Warning: CSC - Promotion Code Report - GenerateReport() :" + ex.ToString());
                NGCTrace.NGCTrace.ExeptionHandling(ex);
                #endregion Trace Error
                return false;
            }
        ...
        protected void TimeFrame_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                #region Trace Start
                NGCTrace.NGCTrace.TraceInfo("Start: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()");
                NGCTrace.NGCTrace.TraceDebug("Start: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()");
                #endregion
                ...
                #region Trace End
                NGCTrace.NGCTrace.TraceInfo("End: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()");
                NGCTrace.NGCTrace.TraceDebug("End: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()");
                #endregion
            }
            catch (Exception ex)
            {
                #region Trace Error
                NGCTrace.NGCTrace.TraceCritical("Critical: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceError("Error: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged()- Error Message :" + ex.ToString());
                NGCTrace.NGCTrace.TraceWarning("Warning: CSC - Promotion Code Report - TimeFrame_SelectedIndexChanged() :" + ex.ToString());
                NGCTrace.NGCTrace.ExeptionHandling(ex);
                #endregion Trace Error
