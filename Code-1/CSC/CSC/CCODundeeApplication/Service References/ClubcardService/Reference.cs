...
namespace CCODundeeApplication.ClubcardService {
    ...
    public partial class GetFuelBalanceRequest : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private CCODundeeApplication.ClubcardService.AccountIDType AccountIdTypeField;
        ...
        public CCODundeeApplication.ClubcardService.AccountIDType AccountIdType {
            get {
    ...
    public partial class GetFuelBalanceResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CCODundeeApplication.ClubcardService.GetBalanceResponse GetBalanceResponseField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CCODundeeApplication.ClubcardService.GetBalanceResponse GetBalanceResponse {
            get {
    ...
    public partial class GetBalanceResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CCODundeeApplication.ClubcardService.Balance BalanceField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CCODundeeApplication.ClubcardService.Balance Balance {
            get {
    ...
    public partial class Balance : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CCODundeeApplication.ClubcardService.BalanceByExpiry[] BalanceByExpiryField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CCODundeeApplication.ClubcardService.BalanceByExpiry[] BalanceByExpiry {
            get {
    ...
    public interface IClubcardService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/ViewCustome" +
            "rHelplineInformation", ReplyAction="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/ViewCustome" +
            "rHelplineInformationResponse")]
        bool ViewCustomerHelplineInformation(out string resultXml, long customerID, string culture);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/GetCallReas" +
            "onCode", ReplyAction="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/GetCallReas" +
            "onCodeResponse")]
        bool GetCallReasonCode(out string errorXml, out string resultXml, string culture);
        ...
        CCODundeeApplication.ClubcardService.GetFuelBalanceResponse GetFuelSaverPointsBalance(CCODundeeApplication.ClubcardService.GetFuelBalanceRequest objReq);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/MergeCards", ReplyAction="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/MergeCardsR" +
            "esponse")]
        bool MergeCards(out string resultXml, out long objectID, string objectXml, int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/AddHelpline" +
            "Information", ReplyAction="http://tesco.com/clubcardonline/datacontract/2010/01/IClubcardService/AddHelpline" +
            "InformationResponse")]
        bool AddHelplineInformation(out long objectID, out string resultXml, string objectXml, short sessionUserID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IClubcardServiceChannel : CCODundeeApplication.ClubcardService.IClubcardService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ClubcardServiceClient : System.ServiceModel.ClientBase<CCODundeeApplication.ClubcardService.IClubcardService>, CCODundeeApplication.ClubcardService.IClubcardService {
        ...
        public bool ViewCustomerHelplineInformation(out string resultXml, long customerID, string culture) {
            return base.Channel.ViewCustomerHelplineInformation(out resultXml, customerID, culture);
        }
        
        public bool GetCallReasonCode(out string errorXml, out string resultXml, string culture) {
            return base.Channel.GetCallReasonCode(out errorXml, out resultXml, culture);
        }
        ...
        public CCODundeeApplication.ClubcardService.GetFuelBalanceResponse GetFuelSaverPointsBalance(CCODundeeApplication.ClubcardService.GetFuelBalanceRequest objReq) {
            return base.Channel.GetFuelSaverPointsBalance(objReq);
        }
        
        public bool MergeCards(out string resultXml, out long objectID, string objectXml, int userID) {
            return base.Channel.MergeCards(out resultXml, out objectID, objectXml, userID);
        }
        
        public bool AddHelplineInformation(out long objectID, out string resultXml, string objectXml, short sessionUserID) {
            return base.Channel.AddHelplineInformation(out objectID, out resultXml, objectXml, sessionUserID);
        }
    }
}
