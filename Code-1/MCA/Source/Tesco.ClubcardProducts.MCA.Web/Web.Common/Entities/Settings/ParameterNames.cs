...
namespace Tesco.ClubcardProducts.MCA.Web.Common.Entities.Settings
{
    public class ParameterNames
    {
        ...
        public const string ENCODEDVALUE = "Encodedvalue";
        ...
        //Identity
        public const string OAUTH_TOKEN = "OAuth.AccessToken";
        public const string OAUTH_REFRESH_TOKEN = "OAuth.RefreshToken";
        public const string UUID = "UUID";
        public const string MCASERVICE_TOKEN = "mcaServiceToken";
        public const string DXSH_CUSTOMERID = "DXSHCustomerId";
        public const string JWT_TOKEN = "_tid";

        public const string RESPONSE_COOKIES = "responsecookie";
    }
}
