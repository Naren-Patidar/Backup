...
namespace Tesco.ClubcardProducts.MCA.Web.Common.Entities.Vouchers
{
    ...
    public class VoucherDetails : ComparableEntity<VoucherDetails>
    {
        ...
        public long PrimaryCustomerCardnumber { get; set; }
        ...
        public long AssociateCustomerCardnumber { get; set; }
        ...
        internal override bool AreInstancesEqual(VoucherDetails target)
        {
            bool bReturn = ((target.HouseholdId == this.HouseholdId) &&
                    ...
                    (target.ExpiryDate.CompareDateTimeOnly(this.ExpiryDate)) &&
        ...
        public override void ConvertFromDataset(DataSet ds)
        {
            ...
            .Select(dr =>
                new VoucherDetails
                {
                    ...
                    ExpiryDate = dr.GetValue<string>(VoucherDetailsProperties.ExpiryDate).TryParseDate(out dtTemp) ? dtTemp : DateTime.Now,
        ...
        public override void ConvertFromXml(string xml)
        {
            ...
            _voucherDetails = (from t in xDoc.Descendants("Table")
                               select new VoucherDetails
                               {
                                   ...
                                   ExpiryDate = t.Element(VoucherDetailsProperties.ExpiryDate).GetValue<string>().TryParseDate(out dtTemp) ? dtTemp : DateTime.Now,
