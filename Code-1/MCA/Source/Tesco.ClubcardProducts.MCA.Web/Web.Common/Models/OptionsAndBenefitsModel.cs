...
namespace Tesco.ClubcardProducts.MCA.Web.Common.Models
{
    public class OptionsAndBenefitsModel
    {
        ...
        CustomerEmail _email = new CustomerEmail();
        bool _IsSaved = false;
        bool _IsValid = true;
        string _errorIds = string.Empty;
        ...
        /// <summary>
        /// will keep track of fields those have validation error
        /// </summary>
        ...
        public string AviosMembershipIdLabel { get; set; }
        public string VirginMembershipIdLabel { get; set; }
        public string BaMembershipIdLabel { get; set; }
