    ...
    public class PersonalDetailsViewModel
    {
        ...
        public Dictionary<string, string> Titles
        {
            get
            {
                ...
                string titleValues = System.Web.HttpContext.GetLocalResourceObject("~/Views/Shared/_PersonalDetails.cshtml", "TitleValue",
                    System.Globalization.CultureInfo.CurrentCulture).ToString();
                titles = titleValues.Split(new string[] { "|" }, StringSplitOptions.RemoveEmptyEntries).ToDictionary<string, string>(v => v);
                return titles;
            }
            set { }
        }
