            ...
            try
            {
                switch (fieldName)
                {
                    case "FirstName":
                        ...
                        break;
                    case "FirstNameForActivation":
                        ValidatorUtility.GetDBConfig(DbConfigurationItemNames.Name1ForActivation.ToString(), DbConfigurationTypeEnum.Length_of_the_input_fields, out configValue1, out configValue2);
                        break;
                    case "Initial":
