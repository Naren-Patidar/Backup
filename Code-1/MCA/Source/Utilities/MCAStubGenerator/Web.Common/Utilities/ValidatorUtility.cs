        ...
        public static bool IsRequiredField(string fieldName)
        {
            ...
            switch (fieldName)
            {
                ...
                case "Title":
                    ...
                    break;
                case "DateOfBirth":
                    isRequired = ValidatorUtility.GetDBConfig(DbConfigurationItemNames.DateOfBirth.ToString(), DbConfigurationTypeEnum.Mandatory_fields, out configValue1, out configValue2);
                    break;
                case "Sex":
