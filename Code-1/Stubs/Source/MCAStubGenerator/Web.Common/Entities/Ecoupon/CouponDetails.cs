    ...
    public class CouponDetailsList : BaseEntity<CouponDetailsList>
    {
        ...
        public override void ConvertFromXml(string xml)
        {
            ...
            _list = (from t in xDoc.Descendants("UsedCouponDetail")
                               ...
                               {
                                   IssuanceStartDate = t.Element(CouponDetailsEnum.IssuanceStartDate.ToString()).GetValue<string>().TryParseDate(out dtTemp) ? dtTemp : DateTime.Now,
                                   RedemptionDate = t.Element(CouponDetailsEnum.RedemptionDate.ToString()).GetValue<string>().TryParseDate(out dtTemp) ? dtTemp : DateTime.Now,
                                   RedemptionStoreName = t.Element(CouponDetailsEnum.RedemptionStoreName.ToString()).GetValue<string>(),
                                   CouponStatus = t.Element(CouponDetailsEnum.CouponStatus.ToString()).GetValue<string>(),
                                   RedemptionCount = t.Element(CouponDetailsEnum.RedemptionCount.ToString()).GetValue<string>(),
                                   CouponDescription = t.Element(CouponDetailsEnum.CouponDescription.ToString()).GetValue<string>(),
                                   TotalRedeemedCoupon = t.Element(CouponDetailsEnum.TotalRedeemedCoupon.ToString()).GetValue<string>(),
                                   TotalRedemption = t.Element(CouponDetailsEnum.TotalRedemption.ToString()).GetValue<string>(),
                                   FullImageName = t.Element(CouponDetailsEnum.FullImageName.ToString()).GetValue<string>(),
                                   BarcodeNumber = t.Element(CouponDetailsEnum.SmartBarcode.ToString()).GetValue<string>(),
                                   ExpiryDate = t.Element(CouponDetailsEnum.RedemptionEndDate.ToString()).GetValue<string>(),
                                   MaxRedemptionLimit = t.Element(CouponDetailsEnum.MaxRedemptionLimit.ToString()).GetValue<Int32>(),
                                   RedemptionUtilized = t.Element(CouponDetailsEnum.RedemptionUtilized.ToString()).GetValue<Int32>(),
                                   ThumbnailImageName = t.Element(CouponDetailsEnum.ThumbnailImageName.ToString()).GetValue<string>(),
                                   SmartAlphaNumeric = t.Element(CouponDetailsEnum.SmartAlphaNumeric.ToString()).GetValue<string>(),
                                   RedemptionEndDate = t.Element(CouponDetailsEnum.RedemptionEndDate.ToString()).GetValue<string>().TryParseDate(out dtTemp) ? dtTemp : DateTime.Now,
                                   Id = index++
                               }).ToList();
        }
