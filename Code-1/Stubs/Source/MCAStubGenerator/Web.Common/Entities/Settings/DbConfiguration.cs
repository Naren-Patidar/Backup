        ...
        public override void ConvertFromXml(string xml)
        {
            ...
            ConfigurationItems = (from t in xDoc.Descendants(ParameterNames.CONFIGURATION_TABLE_NAME)
                                  select new DbConfigurationItem
                                  {
                                      ...
                                      ConfigurationValue1 = t.Element(DbConfigurationItemEnum.ConfigurationValue1.ToString()).GetValue<string>(),
                                      ConfigurationValue2 = t.Element(DbConfigurationItemEnum.ConfigurationValue2.ToString()).GetValue<string>(),
                                      IsDeleted = false
                                  }).ToList();
