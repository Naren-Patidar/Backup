...
{
    public class MYAccountDuplicacyCheck : AccountDuplicacyCheck
    {
        ...
        public override bool IsAccountDuplicate(long ClubcardNumber, ClubcardOnline.Web.Entities.CustomerActivationServices.ClubcardCustomer customer, System.Data.DataSet dsConfig)
        {
            ...
            try
            {
                ...
                //   fileName = string.Format(@"D:\MCA_RefactoredCode\UK\Stub_Jan2016\ClubcardService\DataSource\GetCustomerDetails\en-MY\{0}.xml", ClubcardNumber);
            ...
            {
                throw Extensions.GetCustomException("Failed in MYAccountDuplicacy check while matching CustomerData.", ex, new Dictionary<string, object>() 
                            { 
