...
namespace CustomerService
{
    ...
    public class CustomerService : ICustomerService
    {
        ...
        {
            return provider.GetAlternativeIds(out  errorXml, out  resultXml, out  rowCount,  conditionXml,  maxRowCount,  culture);
        }

        public bool DeLinkingDotcomAccounts(out string resultXml, string objectXml)
        {
            return provider.DeLinkingDotcomAccounts(out resultXml, objectXml);
        }
        ...
        {
            return provider.UpdateCustomerDetails(out errorXml, out customerID, updateXml, consumer);
        }
        ...
        {
            return provider.AddPrintAtHomeDetails(out errorXml, updateDS);
        }
