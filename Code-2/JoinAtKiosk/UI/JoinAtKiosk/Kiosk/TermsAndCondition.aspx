<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermsAndCondition.aspx.cs"
    Inherits="Tesco.Com.Marketing.Kiosk.JoinAtKiosk.Kiosk.TermsAndCondition" %>
    ...
    <div id="wrapper">
        ...
        <div id="body_wrapper">
            <div id="contentCharter">
                <div class="TCwrappercentre">
                    <div class="panelTC curved TCPage1Height">
                      <%= Resources.GlobalResources.TCPage1 %>   
                       <div class="buttons" id="TC1Buttons" runat="server">
                        <div class="TC1highlight">
                                &nbsp;</div>
                            <div id="pg1TC2" runat="server">
                                <a href="TermsAndCondition2.aspx?page=<%=sPage %>">
                                    <div class="TC2normal" style="text-decoration: none">
                                        &nbsp;</div>
                                </a>
                            </div>                           
                            <div id="pg1TC3" runat="server">
                                <a href="TermsAndCondition3.aspx?page=<%=sPage %>">
                                    <div class="TC3normal" style="text-decoration: none">
                                        &nbsp;</div>
                                </a>
                            </div>
                            <div id="pg1TC4" runat="server">
                                <a href="TermsAndCondition4.aspx?page=<%=sPage %>">
                                    <div class="TC4normal" style="text-decoration: none">
                                        &nbsp;</div>
                                </a>
                            </div>
                            <div id="pg1TC5" runat="server">
