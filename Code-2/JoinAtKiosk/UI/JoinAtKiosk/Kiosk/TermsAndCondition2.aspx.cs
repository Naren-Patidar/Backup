...
{
    public partial class TermsAndCondition2 : BaseUIPage
    {
        ...
        private void SetConfiguredTCPages()
        {
            try
            {
                ...
                if (!showPageTC1)
                {
                    pg2TC1.Visible = false;
                }
                if (!showPageTC3)
                {
                    pg2TC3.Visible = false;
                }
                if (!showPageTC4)
                {
                    pg2TC4.Visible = false;
                }
                if (!showPageTC5)
                {
                    pg2TC5.Visible = false;
                }
                if ((!showPageTC1) && (!showPageTC3) && (!showPageTC4) && (!showPageTC5))
                {
                    TC2Buttons.Visible = false;
                }
            }
            catch (Exception ex)
            {
