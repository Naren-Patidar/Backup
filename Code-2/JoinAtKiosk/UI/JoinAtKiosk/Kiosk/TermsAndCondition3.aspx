<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TermsAndCondition3.aspx.cs"
    Inherits="Tesco.Com.Marketing.Kiosk.JoinAtKiosk.Kiosk.TermsAndCondition3" %>
        ...
        <div id="body_wrapper">
            <div id="contentCharter">
                <div class="wrappercentre">
                    <div class="panel curved TCPage3Height">
                        <%= Resources.GlobalResources.TCPage3 %>
                        <div class="buttons" id="TC3Buttons" runat="server">
                            <div id="Pg3TC1" runat="server">
                                <a href="TermsAndCondition.aspx?page=<%=sPage %>">
                                    <div class="TC1normal" style="text-decoration: none">
                                        &nbsp;</div>
                                </a>
                            </div>
                            <div id="Pg3TC2" runat="server">
