(function ($, undefined) {
    $.widget('ui.detail', {
        ...
        _getDetails: function () {
            var ctrl = this;
            var url = "../where/latest/testresult?Environment=" + ctrl.options.environment +"&Country="
              + ctrl.options.country + "&Category=" + ctrl.options.category + "&Result="+ ctrl.options.result;
            $.ajax({
                type: "GET",
                url: url,
                data: [],
