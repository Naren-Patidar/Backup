...
set file=D:\MCA_TESTFRAMEWORK\Tesco.MCA.TestFrameworks\ContentFolder\BatchFiles\CMDLog\cmdoutput.log
...
@echo:
%mstestPath% /testcontainer:"D:\MCA_TESTFRAMEWORK\Tesco.MCA.TestFrameworks\Tesco.Framework.UITesting\bin\Debug\Tesco.Framework.UITesting.dll" /category:%Category% /resultsfile:"D:\MCA_TESTFRAMEWORK\Tesco.MCA.TestFrameworks\TestResults\UITestResult_%module%_%MYDATE%.trx" >"%file%" 
...
"D:\MCA_TESTFRAMEWORK\Tesco.MCA.TestFrameworks\Tesco.Framework.ReportGenerator\bin\Debug\Tesco.Framework.ReportGenerator.exe" 
echo %dashes%
