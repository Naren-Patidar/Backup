...
namespace Tesco.Framework.UITesting.Services
{
    public class ClubcardServiceAdapter
    {
        ...
        //public DataSet GetHouseHoldCustomers(long customerID, string culture)
        //{
        ...
        //public string GetVouchers(long customerID, string culture)
        //{
        //    string Vouchers = string.Empty;
        //    string errorXml = string.Empty, resultXml = string.Empty;
        ...
        //    {
        //        XDocument xmlDoc = XDocument.Parse(resultXml);
        //        Vouchers = (from e in xmlDoc.Descendants("ViewMyAccountDetails")
        //                         select e.Element("Vouchers").GetValue<string>()).ToList().FirstOrDefault();
        //    }
