...
set "File=GD_P1_MF_UK_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.trx"
set "TRX_Report=%TRX_Path%%File%
set "Report_EXE=%Root_Path%Reporting\ReportGenerator.exe"
set "HTML_Report_Path=%Root_Path%Reports\UK_GD\P1\"
set "HTML_File=UK_MF_GD_P1_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.html"
