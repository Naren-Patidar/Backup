...
set "File=PPE_BasicFunctionality_S_UK_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.trx"
...
set "HTML_File=UK_S_PPE_BasicFunctionality_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.html"
