...
set "File=STG_BasicFunctionality_GC_UK_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.trx"
...
set "HTML_File=UK_GC_STG_BasicFunctionality_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.html"
