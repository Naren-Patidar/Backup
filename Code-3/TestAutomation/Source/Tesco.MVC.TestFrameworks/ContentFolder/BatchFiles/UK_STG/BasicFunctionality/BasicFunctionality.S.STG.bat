...
set "File=STG_BasicFunctionality_S_UK_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.trx"
...
set "HTML_File=UK_S_STG_BasicFunctionality_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.html"
