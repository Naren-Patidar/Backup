...
set "File=STG_P0Set8_MF_UK_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.trx"
set "TRX_Report=%TRX_Path%%File%
set "Report_EXE=%Root_Path%Reporting\ReportGenerator.exe"
set "HTML_Report_Path=%Root_Path%Reports\UK_STG\P0Set8\"
set "HTML_File=UK_MF_STG_P0Set8_Reskin_%YYYY%%MMM%%DD%_%HH%%Min%%Sec%.html"
