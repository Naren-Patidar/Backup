...
namespace Tesco.com.IntegrationServices.Messages
{
    [Serializable]
    [DataContract]
    public sealed class GetUnusedVoucherDtlsRsp : ResponseBase
    {
        private DataSet _dsResponse;

        public GetUnusedVoucherDtlsRsp()
            : this(null, null, null, null)
        {
        }

        public GetUnusedVoucherDtlsRsp(DataSet dsResponse)
            : this(null, null, null, dsResponse)
        {
        }

        public GetUnusedVoucherDtlsRsp(string errorLogID, string errorStatusCode, string errorMessage, DataSet dsResponse)
