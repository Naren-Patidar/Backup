...
namespace Tesco.com.IntegrationServices.Messages
{
    [Serializable]
    [DataContract]
    public sealed class GetVoucherValAllCPSRsp : ResponseBase
    {
        private DataSet _dsResponse;

        public GetVoucherValAllCPSRsp()
            : this(null, null, null, null)
        {
        }

        public GetVoucherValAllCPSRsp(DataSet dsResponse)
            : this(null, null, null, dsResponse)
        {
        }

        public GetVoucherValAllCPSRsp(string errorLogID, string errorStatusCode, string errorMessage, DataSet dsResponse)
