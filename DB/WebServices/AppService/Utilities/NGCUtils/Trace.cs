...
namespace Tesco.NGC.Utils
{
	...
	#endregion
	#region Trace
	public class Trace : IExceptionPublisher {
		...
		/// </summary>
		public TraceFlags TraceLevel { get { return this.traceLevel; } }
		...
		public TraceState StartProc(string procedureName) {
		...
		public void EndProc(TraceState trState) {
			try {
				trState.EndProc();
			} catch {}
		}
	...
	public class TraceState
	{
		...
		public TraceState(Trace trace, string procName) {
			try {
	...
	internal class TraceQueue : Queue, IDisposable {
		...
		internal TraceQueue(string traceDirectory, string traceName) : base(QUEUE_SIZE) {
