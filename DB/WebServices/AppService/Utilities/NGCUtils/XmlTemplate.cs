...
namespace Tesco.NGC.Utils
{
	...
	public class XmlTemplate 
	{
		...
		public XmlTemplate(string templateSource,Trace trace, bool isTemplateFile,bool checkElements) 
		{
			this.trace = trace;
			TraceState trState = null;
			if (this.trace != null)
		...
		/// <param name="trace">The trace to which an messages is written.</param>
		public XmlTemplate(string fileName,Trace trace) : this(fileName,trace,true,true)
		{
		}
