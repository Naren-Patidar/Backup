...
namespace Fujitsu.eCrm.Generic.SharedUtils
{
    ...
    public class CrmServiceException : ApplicationException
    {
        ...
        public CrmServiceException
            ...
            ITrace trace,
            params string[] args)
            : base(CrmStringBuilder.BuildMessage(CrmServiceException.resourceList, messageName, args), innerException)
        {
        ...
        public CrmServiceException(
            ...
            ITrace trace,
            params string[] args)
            : base(CrmStringBuilder.BuildMessage(CrmServiceException.resourceList, messageName, args))
        {
        ...
        /// <summary>
        /// Create an Exception that incorporates an inner exception
        /// To be used only by Fujitsu.eCrm.Result
        /// </summary>
        /// <param name="actor">The system responsible for the error</param>
        /// <param name="category">The error category</param>
        /// <param name="messageName">The name of the resource that forms a template error message</param>
        ...
        private void Trace()
        {
            this.Trace(new Fujitsu.eCrm.Generic.SharedUtils.Trace());
        }

        private void Trace(ITrace trace)
        {
            if (trace != null)
            {
        ...
        static CrmServiceException()
        {
            ...
            CrmServiceException.resourceList.Push(
                new ResourceManager("Fujitsu.eCrm.Generic.SharedUtils.Resources.ErrorMessages", Assembly.GetExecutingAssembly()));
        }
        ...
        {
            throw (new CrmServiceException("Library", "XmlError", "XmlValidationError", e.Message));
        }
        #endregion
        ...
        public string Actor() { return this.Actor(); }
        ...
        public string UiMessage() { return this.UiMessage(); }
