...
namespace InstoreClubcardReward.Data
{
    ...
    #region usp_UpdateTranDetailsPrintTime Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateTranDetailsVerifiedTime stored procedure.
    /// </summary>
    public class UpdateTranDetailsPrintTime
    {
        ...
        #region Constructors
        public UpdateTranDetailsPrintTime()
        {
        }

        public UpdateTranDetailsPrintTime(string connectionString)
        {
            this.ConnectionString = connectionString;
        }

        public UpdateTranDetailsPrintTime(SqlConnection connection)
        {
            this.Connection = connection;
        }

        public UpdateTranDetailsPrintTime(SqlConnection connection, SqlTransaction transaction)
        {
            this.Connection = connection;
...
string connectionString,
        ...
        {
            UpdateTranDetailsPrintTime updateTranDetailsPrintTime = new UpdateTranDetailsPrintTime();

            #region Assign Property Values
            updateTranDetailsPrintTime.ConnectionString = connectionString;
            updateTranDetailsPrintTime.TransactionID = transactionID;
            updateTranDetailsPrintTime.Status = status;
            updateTranDetailsPrintTime.PrintDate = printDate;
          
            #endregion

            updateTranDetailsPrintTime.Execute();
