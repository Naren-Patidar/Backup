...
namespace InstoreClubcardReward.Data
{
    ...
    #region usp_UpdateTranDetailsVerifiedStartTime Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateTranDetailsVerifiedStartTime stored procedure.
    /// </summary>
    public class UpdateTranDetailsVerifiedStartTime
    {
        ...
        protected SqlDateTime _startTime = SqlDateTime.Null;
        protected bool _startTimeSet = false;
        protected SqlInt32 _status = SqlInt32.Null;
        protected bool _statusSet = false;
        #endregion

        #region Constructors
        public UpdateTranDetailsVerifiedStartTime()
        {
        }

        public UpdateTranDetailsVerifiedStartTime(string connectionString)
        {
            this.ConnectionString = connectionString;
        }

        public UpdateTranDetailsVerifiedStartTime(SqlConnection connection)
        {
            this.Connection = connection;
        }

        public UpdateTranDetailsVerifiedStartTime(SqlConnection connection, SqlTransaction transaction)
        {
            this.Connection = connection;
        ...
        /// <summary>
        /// This method calls the usp_UpdateTranDetailsVerifiedStartTime stored procedure.
        /// </summary>
        public virtual void Execute()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[usp_UpdateTranDetailsStartTime]";
                ...
                SqlParameter prmStartTime = cmd.Parameters.Add("@StartTime", SqlDbType.DateTime);
                prmStartTime.Direction = ParameterDirection.Input;
                if (_startTimeSet == true || this.StartTime.IsNull == false)
                {
                    prmStartTime.Value = this._startTime;
                }


                //SqlParameter prmEndTime = cmd.Parameters.Add("@EndTime", SqlDbType.DateTime);
                //prmEndTime.Direction = ParameterDirection.Input;
                //if (_endTimeSet == true || this.EndTime.IsNull == false)
                //{
                //    prmEndTime.Value = this._endTime;
                //}
...
string connectionString,
        ...
        {
            UpdateTranDetailsVerifiedStartTime UpdateTranDetailsVerifiedStartTime = new UpdateTranDetailsVerifiedStartTime();

            #region Assign Property Values
            UpdateTranDetailsVerifiedStartTime.ConnectionString = connectionString;
            UpdateTranDetailsVerifiedStartTime.TransactionID = transactionID;
            UpdateTranDetailsVerifiedStartTime.StartTime = startTime;
            UpdateTranDetailsVerifiedStartTime.Status = status;
            #endregion

            UpdateTranDetailsVerifiedStartTime.Execute();
