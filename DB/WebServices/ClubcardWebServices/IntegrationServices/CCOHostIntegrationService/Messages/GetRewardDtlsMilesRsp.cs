...
namespace Tesco.com.IntegrationServices.Messages
{
    [Serializable]
    [DataContract]
    public sealed class GetRewardDtlsMilesRsp: ResponseBase
    {
        private DataSet _dsResponse;

        public GetRewardDtlsMilesRsp()
            : this(null, null, null, null)
        {
        }

        public GetRewardDtlsMilesRsp(DataSet dsResponse)
            : this(null, null, null, dsResponse)
        {
        }

        public GetRewardDtlsMilesRsp(string errorLogID, string errorStatusCode, string errorMessage, DataSet dsResponse)
