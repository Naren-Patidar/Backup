...
namespace Tesco.com.IntegrationServices.Messages
{
    [Serializable]
    [DataContract]
    public sealed class GetRewardDtlsRsp : ResponseBase
    {
        private DataSet _dsResponse;

        public GetRewardDtlsRsp()
            : this(null, null, null, null)
        {
        }


        public GetRewardDtlsRsp(DataSet dsResponse)
            : this(null, null, null, dsResponse)
        {
        }

        public GetRewardDtlsRsp(string errorLogID, string errorStatusCode, string errorMessage, DataSet dsResponse)
