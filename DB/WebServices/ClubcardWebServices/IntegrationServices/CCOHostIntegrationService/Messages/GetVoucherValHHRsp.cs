...
namespace Tesco.com.IntegrationServices.Messages
{
    [Serializable]
    [DataContract]
    public sealed class GetVoucherValHHRsp : ResponseBase
    {
        private DataSet _dsResponse;

        public GetVoucherValHHRsp()
            : this(null, null, null, null)
        {
        }

        public GetVoucherValHHRsp(DataSet dsResponse)
            : this(null, null, null, dsResponse)
        {
        }

        public GetVoucherValHHRsp(string errorLogID, string errorStatusCode, string errorMessage, DataSet dsResponse)
