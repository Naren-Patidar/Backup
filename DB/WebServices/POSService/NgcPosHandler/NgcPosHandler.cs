			...
			switch (returnCode) {
				...
				case 1: // Transaction already added
					CrmServiceException ce1 = new CrmServiceException(
						...
						txnNbr,
						FromHex(ngcPosDialog.InBuffer,ngcPosDialog.Length));
                    Fujitsu.eCrm.Generic.SharedUtils.WebException wbce1 = new Fujitsu.eCrm.Generic.SharedUtils.WebException();
                    wbce1.ProcessException(ce1);
				...
				case 7: // Transaction Date is in the future
					CrmServiceException ce7 = new CrmServiceException(
						...
						txnNbr,
						FromHex(ngcPosDialog.InBuffer,ngcPosDialog.Length));
                    Fujitsu.eCrm.Generic.SharedUtils.WebException wbce7 = new Fujitsu.eCrm.Generic.SharedUtils.WebException();
                    wbce7.ProcessException(ce7);
				...
				case 257: // Database Unavailable
					CrmServiceException ce257 = new CrmServiceException(
						...
						this.StorePort.ToString(),
						FromHex(ngcPosDialog.InBuffer,ngcPosDialog.Length));
                    Fujitsu.eCrm.Generic.SharedUtils.WebException wbce257 = new Fujitsu.eCrm.Generic.SharedUtils.WebException();
                    wbce257.ProcessException(ce257);
					//ExceptionManager.Publish(ce257);
					return false;
				case 258: // Points Limit Exceeded
					CrmServiceException ce258 = new CrmServiceException(
						...
						points,
						FromHex(ngcPosDialog.InBuffer,ngcPosDialog.Length));
                    Fujitsu.eCrm.Generic.SharedUtils.WebException wbce258 = new Fujitsu.eCrm.Generic.SharedUtils.WebException();
                    wbce258.ProcessException(ce258);
			...
			switch (returnCode) {
				...
				case 1: // Transaction is unknown
					CrmServiceException ce = new CrmServiceException(
						...
						txnNbr,
						FromHex(ngcPosDialog.InBuffer,ngcPosDialog.Length));
                    Fujitsu.eCrm.Generic.SharedUtils.WebException wbce = new Fujitsu.eCrm.Generic.SharedUtils.WebException();
                    wbce.ProcessException(ce);
