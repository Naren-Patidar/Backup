...
namespace BigExchange.Service
{
    ...
    public class ClubcardReward : IClubcardReward
    {
        ...
        private InstoreClubcardReward.Business.UnusedCouponCollection _bizUnusedCouponCollection;
        ...
        private void ParseTransPrintVoucherToBiz(BookingPrintVoucher bookingPrintVoucher)
        {
            ...
            _bizBookingPrintVoucher.totalActiveCoupons = bookingPrintVoucher.totalActiveCoupons;
            _bizBookingPrintVoucher.CouponStatusID = bookingPrintVoucher.CouponStatusID;
            


            //added extra params for international kiosk
            _bizBookingPrintVoucher.FirstName = bookingPrintVoucher.FirstName;
            _bizBookingPrintVoucher.Surname = bookingPrintVoucher.Surname;
            _bizBookingPrintVoucher.DOB = bookingPrintVoucher.DOB;
            _bizBookingPrintVoucher.SSN = bookingPrintVoucher.SSN;
            _bizBookingPrintVoucher.Email = bookingPrintVoucher.Email;
            _bizBookingPrintVoucher.MobileNo = bookingPrintVoucher.MobileNo;

            //_bizBookingPrintVoucher.CouponDescription = bookingPrintVoucher.CouponDescription;
            //_bizBookingPrintVoucher.SmartBarcode = bookingPrintVoucher.SmartBarcode;
            //_bizBookingPrintVoucher.SmartAlphaCode = bookingPrintVoucher.SmartAlphaCode;
            //_bizBookingPrintVoucher.CouponExpiryDate = bookingPrintVoucher.CouponExpiryDate;
            //_bizBookingPrintVoucher.ActiveCoupons = bookingPrintVoucher.ActiveCoupons;
            ...
            foreach (UnusedCoupon dataCoupon in bookingPrintVoucher.UnusedCoupons)
            {
                InstoreClubcardReward.Business.UnusedCoupon bizUnusedCoupon = new InstoreClubcardReward.Business.UnusedCoupon();
                bizUnusedCoupon.CouponDescription = dataCoupon.CouponDescription;
                bizUnusedCoupon.SmartBarcode = dataCoupon.SmartBarcode;
                bizUnusedCoupon.SmartAlphaCode = dataCoupon.SmartAlphaCode;
                bizUnusedCoupon.CouponExpiryDate = dataCoupon.CouponExpiryDate;
                bizUnusedCoupon.ActiveCoupons = dataCoupon.ActiveCoupons;
                _bizBookingPrintVoucher.UnusedCoupons.Add(bizUnusedCoupon);
            }
        }
        ...
        private BigExchange.BookingPrintVoucher ParseBizToTransPrintVoucher(BigExchange.BookingPrintVoucher bizBookingPrintVoucher)
        {
            ...
            _bizBookingPrintVoucher.totalActiveCoupons = bizBookingPrintVoucher.totalActiveCoupons;
            _bizBookingPrintVoucher.CouponStatusID = bizBookingPrintVoucher.CouponStatusID;
            

            //added extra params for international kiosk
            _bookingPrintVoucher.FirstName = bizBookingPrintVoucher.FirstName;
            _bookingPrintVoucher.Surname = bizBookingPrintVoucher.Surname;
            _bookingPrintVoucher.DOB = bizBookingPrintVoucher.DOB;
            _bookingPrintVoucher.SSN = bizBookingPrintVoucher.SSN;
            _bookingPrintVoucher.Email = bizBookingPrintVoucher.Email;
            _bookingPrintVoucher.MobileNo = bizBookingPrintVoucher.MobileNo;
            ...
            foreach (BigExchange.UnusedCoupon bizUnusedCoupon in bizBookingPrintVoucher.UnusedCoupons)
            {
                UnusedCoupon _unusedCoupon = new UnusedCoupon();
                _unusedCoupon.CouponDescription = bizUnusedCoupon.CouponDescription;
                _unusedCoupon.SmartBarcode = bizUnusedCoupon.SmartBarcode;
                _unusedCoupon.SmartAlphaCode = bizUnusedCoupon.SmartAlphaCode;
                _unusedCoupon.CouponExpiryDate = bizUnusedCoupon.CouponExpiryDate;
                _unusedCoupon.ActiveCoupons = bizUnusedCoupon.ActiveCoupons;
                _bookingPrintVoucher.UnusedCoupons.Add(_unusedCoupon);
            }
            ...
            try
            {
                switch (loggingOperations)
                {
                    ...
                    case LoggingOperations.UpdateTranDetailsVerifiedTime:
                        ...
                        break;
                    case LoggingOperations.SaveUnusedCoupons:
                        SaveUnusedCoupons(bookingPrintVoucher);
                        break;
                }
            }
        ...
        /// </summary>
        /// <param name="bookingPrintVoucher"></param>
        private void SaveUnusedCoupons(BookingPrintVoucher bookingPrintVoucher)
        {
            try
            {
                //_bizBookingPrintVoucher = new InstoreClubcardReward.Business.BookingPrintVoucher();
                ParseTransPrintVoucherToBiz(bookingPrintVoucher);
                _bizBookingPrintVoucher.UnusedCoupons.Save(bookingPrintVoucher.TransactionID);
            }
            catch (Exception ex)
            {
                CustomException objCustEx = new CustomException();
