...
{
	#region usp_UpdateBooking Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateBooking stored procedure.
    /// </summary>
    public class UpdateBooking
    {
		...
		public UpdateBooking(string connectionString)
		{
			this.ConnectionString = connectionString;
		}
		
		public UpdateBooking(SqlConnection connection)
		{
			this.Connection = connection;
		}
		
		public UpdateBooking(SqlConnection connection, SqlTransaction transaction)
		{
			this.Connection = connection;
		...
		/// <summary>
		/// The connection string to use when executing the usp_UpdateBooking stored procedure.
		/// </summary>
        ...
        /// <summary>
        /// The connection to use when executing the usp_UpdateBooking stored procedure.
        ...
        /// <summary>
        /// The transaction to use when executing the usp_UpdateBooking stored procedure.
		...
		/// <summary>
		/// Gets the return value from the usp_UpdateBooking stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the usp_UpdateBooking stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the usp_UpdateBooking stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			try
			{
				...
				cmd.CommandText = "[dbo].[usp_UpdateBooking]";
		    ...
		    )
		{
			...
			updateBooking.ConnectionString = connectionString;
