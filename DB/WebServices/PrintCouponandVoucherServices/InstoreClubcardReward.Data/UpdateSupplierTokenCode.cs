...
{
	#region usp_UpdateSupplierTokenCode Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateSupplierTokenCode stored procedure.
    /// </summary>
    public class UpdateSupplierTokenCode
    {
		...
		#region Constructors
		public UpdateSupplierTokenCode()
		{
		}
		
		public UpdateSupplierTokenCode(string connectionString)
		{
			this.ConnectionString = connectionString;
		}
		
		public UpdateSupplierTokenCode(SqlConnection connection)
		{
			this.Connection = connection;
		}
		
		public UpdateSupplierTokenCode(SqlConnection connection, SqlTransaction transaction)
		{
			this.Connection = connection;
		...
		/// <summary>
		/// The connection string to use when executing the usp_UpdateSupplierTokenCode stored procedure.
		/// </summary>
        ...
        /// <summary>
        /// The connection to use when executing the usp_UpdateSupplierTokenCode stored procedure.
        ...
        /// <summary>
        /// The transaction to use when executing the usp_UpdateSupplierTokenCode stored procedure.
		...
		/// <summary>
		/// Gets the return value from the usp_UpdateSupplierTokenCode stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the usp_UpdateSupplierTokenCode stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the usp_UpdateSupplierTokenCode stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			try
			{
				...
				cmd.CommandText = "[dbo].[usp_UpdateSupplierTokenCode]";
		...
		{
			UpdateSupplierTokenCode updateSupplierTokenCode = new UpdateSupplierTokenCode();
			
			#region Assign Property Values
			updateSupplierTokenCode.ConnectionString = connectionString;
			updateSupplierTokenCode.Id = id;
			updateSupplierTokenCode.CustomerDate = customerDate;
			updateSupplierTokenCode.TokenId = tokenId;
			#endregion
			
			updateSupplierTokenCode.Execute();
