...
namespace InstoreClubcardReward.Data
{
    ...
    #region usp_UpdateTranDetailsVerifiedTime Wrapper
    /// <summary>
    /// This class is a wrapper for the usp_UpdateTranDetailsVerifiedTime stored procedure.
    /// </summary>
    public class UpdateTranDetailsVerifiedTime
    {
        ...
        protected SqlDateTime _endTime = SqlDateTime.Null;
        protected bool _startTimeSet = false;
        protected bool _endTimeSet = false;
        protected SqlInt32 _status = SqlInt32.Null;
        protected bool _statusSet = false;
        #endregion

        #region Constructors
        public UpdateTranDetailsVerifiedTime()
        {
        }

        public UpdateTranDetailsVerifiedTime(string connectionString)
        {
            this.ConnectionString = connectionString;
        }

        public UpdateTranDetailsVerifiedTime(SqlConnection connection)
        {
            this.Connection = connection;
        }

        public UpdateTranDetailsVerifiedTime(SqlConnection connection, SqlTransaction transaction)
        {
            this.Connection = connection;
        ...
        public virtual void Execute()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[dbo].[usp_UpdateTranDetailsEndTime]";
...
string connectionString,
        ...
        {
            UpdateTranDetailsVerifiedTime updateTranDetailsVerifiedTime = new UpdateTranDetailsVerifiedTime();

            #region Assign Property Values
            updateTranDetailsVerifiedTime.ConnectionString = connectionString;
            updateTranDetailsVerifiedTime.TransactionID = transactionID;
            updateTranDetailsVerifiedTime.StartTime = startTime;
            updateTranDetailsVerifiedTime.EndTime = EndTime;
            updateTranDetailsVerifiedTime.Status = status;
            #endregion

            updateTranDetailsVerifiedTime.Execute();
