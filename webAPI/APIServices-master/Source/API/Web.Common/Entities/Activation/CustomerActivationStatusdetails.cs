...
namespace Tesco.ClubcardProducts.MCA.API.Common.Entities.Activation
{
    public class CustomerActivationStatusdetails : BaseEntity<CustomerActivationStatusdetails>
    {
        ...
        public override void ConvertFromXml(string xml)
        {
            ...
            this.CustomerId = (from t in xDoc.Descendants("ViewCheckCustomerActivated") select t.Element(CustomerActivationDetailsEnum.CustomerID).GetValue<string>()).FirstOrDefault();
            this.Activated = (from t in xDoc.Descendants("ViewCheckCustomerActivated") select t.Element(CustomerActivationDetailsEnum.Activated).GetValue<string>()).FirstOrDefault();
    ...
    public class CustomerActivationStatusdetailsList : BaseEntity<CustomerActivationStatusdetailsList>
    {
        ...
        public override void ConvertFromXml(string xml)
        {
            ...
            _CustomerActivationStatusdetails = (from t in xDoc.Descendants("ViewCheckCustomerActivated")
                               ...
                               {
                                   CustomerId = t.Element(CustomerActivationDetailsEnum.CustomerID).GetValue<string>(),
                                   Activated = t.Element(CustomerActivationDetailsEnum.Activated).GetValue<string>()
