...
namespace Tesco.ClubcardProducts.MCA.API.Common.Entities.Points
{
    public class PointsSummary
    {
        ...
        public Dictionary<PointsTypeEnum, string> pointsBreakup = new Dictionary<PointsTypeEnum, string>();
                ...
                foreach (string pointsTypeLiteral in Enum.GetNames(typeof(PointsTypeEnum)))
                {
                    ...
                    foreach (XElement r in xDoc.Descendants("PointsSummaryRec"))
                    {
                        if (r.Element(pointsTypeLiteral) != null)
                        {
                            ...
                            {
                                _pointSummaryList[i].pointsBreakup.Add(pointsType, points.ToString());
                            }
                        }
                        else
                        {
