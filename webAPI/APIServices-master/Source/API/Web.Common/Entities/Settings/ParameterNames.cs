...
namespace Tesco.ClubcardProducts.MCA.API.Common.Entities.Settings
{
    public class ParameterNames
    {
        ...
        #region Enterprise Services

        //Identity
        public const string OAUTH_TOKEN = "oAuthToken";
        public const string OAUTH_REFRESH_TOKEN = "oAuthRefreshToken";
       
        //Address
        public const string PARTIAL_POSTCODE = "partialpostcode";
        public const string AddressUUID = "addressId";

        #endregion

        public const string TYPE = "type";
        public const string METHOD_PARAMETERS = "parameters";
    }
}