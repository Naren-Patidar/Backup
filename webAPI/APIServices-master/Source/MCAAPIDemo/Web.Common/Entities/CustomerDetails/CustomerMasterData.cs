    ...
    public class CustomerMasterData : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (!String.IsNullOrEmpty(Sex)
                && DBConfigurationManager.Instance[DbConfigurationTypeEnum.ChinaHiddenFunctionality][DbConfigurationItemNames.ChinaHiddenFunctionalityTitle].ConfigurationValue1 != "1")
            {
