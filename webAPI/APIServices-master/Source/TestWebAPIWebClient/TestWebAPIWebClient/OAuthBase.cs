...
namespace TestWebAPIWebClient
{
    public class OAuthBase
    {
        ...
        public string GenerateSignature(Uri url, string consumerKey, string consumerSecret, string token, string tokenSecret, string httpMethod, string timeStamp, string nonce, SignatureTypes signatureType, out string normalizedUrl, out string normalizedRequestParameters)
        {
            ...
            switch (signatureType)
            {
                ...
                case SignatureTypes.HMACSHA1:
                    ...
                    string signatureBase = consumerKey + timeStamp + nonce + consumerSecret;
                    signatureBase = signatureBase.ToLower();

                    ASCIIEncoding encoding = new ASCIIEncoding();
                    byte[] keyByte = encoding.GetBytes(consumerSecret.ToLower());
        ...
        public static byte[] GetPreSaltBytes()
        {
            int saltLength = GetSaltLength();
